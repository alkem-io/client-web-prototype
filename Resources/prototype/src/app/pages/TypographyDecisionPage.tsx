...
function Decision1_TextSize() {
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-page-title font-semibold tracking-tight mb-1">Decision 1: Small Text Token</h2>
        <p className="text-muted-foreground">
          Currently <code className="text-caption bg-muted px-1 py-0.5 rounded">text-caption</code> = 12px, but ~50 places use 10px for badges/captions.
          Should we add a <code className="text-caption bg-muted px-1 py-0.5 rounded">text-2xs</code> (10px) or round up to 12px?
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-2 border-muted/30 opacity-60">
          <CardHeader>
            <CardTitle className="text-subheader font-normal flex items-center gap-2">
              <span className="bg-blue-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-caption font-bold">A</span>
              Add text-2xs (10px)
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-body text-muted-foreground">Keep a 10px size for compact UI elements. More precision, more tokens.</p>

            <div className="space-y-3 p-4 bg-muted/30 rounded-lg">
              <p className="text-caption text-muted-foreground uppercase tracking-wider">Live Preview</p>

              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Badges at 10px:</span>
              ...
              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Sidebar label at 10px:</span>
                <span className="font-semibold tracking-wider uppercase" style={{ fontSize: "10px", color: "var(--muted-foreground)" }}>MY SPACES</span>
              </div>

              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Avatar initials at 10px:</span>
              ...
              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Meta text at 10px:</span>
        ...
        <Card className="border-2 border-green-500 ring-2 ring-green-500/20">
          <CardHeader>
            <CardTitle className="text-subheader font-normal flex items-center gap-2">
              <span className="bg-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-caption font-bold"><Check className="w-3.5 h-3.5" /></span>
              Round up to text-caption (12px)
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-body text-muted-foreground">Fewer tokens, easier to maintain. Everything small becomes 12px.</p>

            <div className="space-y-3 p-4 bg-muted/30 rounded-lg">
              <p className="text-caption text-muted-foreground uppercase tracking-wider">Live Preview</p>

              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Badges at 12px:</span>
                <span className="inline-flex items-center rounded-md border px-2 py-0.5 text-caption">Lead</span>
                <span className="inline-flex items-center rounded-md border px-2 py-0.5 text-caption">Member</span>
                <span className="inline-flex items-center rounded-md border bg-primary/10 text-primary px-2 py-0.5 text-caption">Private</span>
              </div>

              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Sidebar label at 12px:</span>
                <span className="text-caption font-semibold tracking-wider uppercase text-muted-foreground">MY SPACES</span>
              </div>

              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Avatar initials at 12px:</span>
                <div className="w-6 h-6 rounded-full bg-primary flex items-center justify-center text-white text-caption font-bold">JN</div>
                <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white text-caption font-bold">AB</div>
              </div>

              <div className="flex items-center gap-2">
                <span className="text-body-emphasis">Meta text at 12px:</span>
                <span className="text-caption text-muted-foreground">In: Climate Action Hub · 3 min ago</span>
              </div>
            </div>
          </CardContent>
        </Card>
...
function Decision2_Headings() {
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-page-title font-semibold tracking-tight mb-1">Decision 2: Heading System</h2>
        <p className="text-muted-foreground">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card className="border-2 border-muted/30 opacity-60">
          ...
          <CardContent className="space-y-4">
            <p className="text-body text-muted-foreground">
              Keep theme.css base styles. Use bare <code className="text-caption bg-muted px-1 py-0.5 rounded">&lt;h1&gt;</code>–<code className="text-caption bg-muted px-1 py-0.5 rounded">&lt;h4&gt;</code> everywhere.
            </p>
            <div className="p-4 bg-muted/30 rounded-lg space-y-3">
              <p className="text-caption text-muted-foreground uppercase tracking-wider">Live Preview</p>
              <h1 style={{ fontSize: "48px", fontWeight: 800, lineHeight: 1 }}>Page Title (h1)</h1>
              <h2 style={{ fontSize: "30px", fontWeight: 600, lineHeight: 1.2 }}>Section Heading (h2)</h2>
              <h3 style={{ fontSize: "24px", fontWeight: 600, lineHeight: 1.33 }}>Card Title (h3)</h3>
              <h4 style={{ fontSize: "20px", fontWeight: 600, lineHeight: 1.4 }}>Sidebar Title (h4)</h4>
            </div>
        ...
        <Card className="border-2 border-green-500 ring-2 ring-green-500/20">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="p-4 bg-muted/30 rounded-lg space-y-3">
              ...
              <div className="text-page-title font-semibold leading-snug">Card Title (text-2xl)</div>
              <div className="text-section-title leading-normal">Sidebar Title (text-section-title)</div>
            </div>
            <div className="text-caption text-muted-foreground space-y-1">
        ...
        <Card className="border-2 border-red-500/30 opacity-60">
          <CardHeader>
            <CardTitle className="text-subheader font-normal flex items-center gap-2">
              <span className="bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-caption font-bold">C</span>
              Current state (mixed)
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="p-4 bg-muted/30 rounded-lg space-y-3">
              <p className="text-caption text-muted-foreground uppercase tracking-wider">Live Preview — same "section heading" done 3 ways</p>
              <h2 className="text-page-title">About (Tailwind + tracking)</h2>
              <h2 className="text-page-title font-semibold mb-2">About (Tailwind, no tracking)</h2>
...
function Decision3_Badges() {
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-page-title font-semibold tracking-tight mb-1">Decision 3: Badge / Tag Standard</h2>
        <p className="text-muted-foreground">
      ...
      <Card className="border-2 border-red-500/30">
        <CardHeader>
          <CardTitle className="text-subheader font-normal">Current State — inconsistent badges across the platform</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="space-y-1 text-center">
              <Badge variant="secondary" className="font-normal text-caption">text-caption font-normal</Badge>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="border-2 border-green-500 ring-2 ring-green-500/20">
          <CardHeader>
            <CardTitle className="text-subheader font-normal flex items-center gap-2">
              <span className="bg-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-caption font-bold"><Check className="w-3.5 h-3.5" /></span>
              text-caption (12px) font-medium
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-body text-muted-foreground">Matches Tailwind scale. Slightly larger, more readable.</p>
            <div className="flex flex-wrap gap-2 p-3 bg-muted/30 rounded-lg">
              <Badge className="text-caption">Lead</Badge>
              <Badge variant="secondary" className="text-caption">Member</Badge>
              <Badge variant="outline" className="text-caption">Private</Badge>
              <Badge variant="destructive" className="text-caption">Archived</Badge>
              <Badge variant="secondary" className="text-caption">3 Active</Badge>
              <Badge variant="outline" className="text-caption">V2</Badge>
              <Badge variant="outline" className="text-caption">Innovation</Badge>
              <Badge variant="secondary" className="text-caption">Whiteboard</Badge>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 border-muted/30 opacity-60">
          <CardHeader>
            <CardTitle className="text-subheader font-normal flex items-center gap-2">
              <span className="bg-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-caption font-bold">B</span>
              11px font-medium
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-body text-muted-foreground">In between. Compact but still legible. Would use text-2xs.</p>
            <div className="flex flex-wrap gap-2 p-3 bg-muted/30 rounded-lg">
        ...
        <Card className="border-2 border-muted/30 opacity-60">
          <CardHeader>
            <CardTitle className="text-subheader font-normal flex items-center gap-2">
              <span className="bg-purple-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-caption font-bold">C</span>
              10px font-semibold
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-body text-muted-foreground">Most compact. Bolder weight compensates for small size.</p>
            <div className="flex flex-wrap gap-2 p-3 bg-muted/30 rounded-lg">
...
function Decision4_Tracking() {
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-page-title font-semibold tracking-tight mb-1">Decision 4: Letter-Spacing</h2>
        <p className="text-muted-foreground">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="border-2 border-red-500/30 opacity-60">
          <CardHeader>
            <CardTitle className="text-subheader font-normal">Current: 8+ variants</CardTitle>
          </CardHeader>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={label} className="flex items-center gap-3">
                  ...
                  <span className={`text-body-emphasis ${cls || ""}`} style={style}>
                    {text}
                  </span>
                </div>
              ))}
          ...
          <CardContent className="space-y-3 p-4">
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-page-title font-semibold tracking-tight">Section Heading</p>
                <p className="text-caption text-muted-foreground">Use for: large headings (text-section-title and above)</p>
              </div>
              <Separator />
              <div className="space-y-1">
                <code className="text-[10px] bg-muted px-1.5 py-0.5 rounded font-mono">tracking-normal (0)</code>
                <p className="text-body-emphasis tracking-normal">Body text, buttons, labels, nav items</p>
                <p className="text-caption text-muted-foreground">Use for: everything else (default, no class needed)</p>
              </div>
              <Separator />
              <div className="space-y-1">
                <code className="text-[10px] bg-muted px-1.5 py-0.5 rounded font-mono">tracking-wider (0.05em)</code>
                <p className="text-caption font-semibold tracking-wider uppercase text-muted-foreground">SECTION LABEL</p>
                <p className="text-caption text-muted-foreground">Use for: uppercase labels and overlines only</p>
              </div>
            </div>
          </CardContent>
        </Card>
...
function Decision5_Weights() {
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-page-title font-semibold tracking-tight mb-1">Decision 5: Weight Strategy</h2>
        <p className="text-muted-foreground">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="border-2 border-muted/30 opacity-60">
          ...
          <CardContent className="space-y-4">
            <p className="text-body text-muted-foreground">Clean separation. Body=400, interactive=500, headings=600.</p>
            <div className="p-4 bg-muted/30 rounded-lg space-y-3">
              <div className="text-page-title font-semibold">Section Heading (600)</div>
              <div className="text-subsection-title">Card Title (600)</div>
              <div className="text-body-emphasis">Button / Tab / Label (500)</div>
              <div className="text-body font-normal">Body text and descriptions (400)</div>
              <div className="text-caption font-normal text-muted-foreground">Metadata, timestamps (400)</div>
            </div>
        ...
        <Card className="border-2 border-green-500 ring-2 ring-green-500/20">
          ...
          <CardContent className="space-y-4">
            <p className="text-body text-muted-foreground">More range. Page titles get 700, section headings get 600.</p>
            <div className="p-4 bg-muted/30 rounded-lg space-y-3">
              <div className="text-page-title">Page Title (700)</div>
              <div className="text-section-title">Section Heading (600)</div>
              <div className="text-subsection-title">Card Title (600)</div>
              <div className="text-body-emphasis">Button / Tab / Label (500)</div>
              <div className="text-body font-normal">Body text and descriptions (400)</div>
              <div className="text-caption font-normal text-muted-foreground">Metadata, timestamps (400)</div>
...
const TOKENS: TokenDef[] = [
  ...
  },
  {
    ...
    tw: "text-page-title font-semibold tracking-tight",
    size: "24px",
    weight: 600,
    tracking: "tight",
    category: "system",
  ...
  {
    name: "Subsection",
    tw: "text-subheader font-semibold",
    size: "16px",
    weight: 600,
    tracking: "normal",
    category: "system",
  ...
  {
    name: "Prose H2",
    tw: "text-section-title tracking-tight",
    size: "20px",
    weight: 600,
    tracking: "tight",
    category: "user-input",
...
function ProposedTokenTable() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <h2 className="text-page-title font-semibold tracking-tight mb-1">Finalized Token Table</h2>
        <p className="text-muted-foreground max-w-3xl">
          Based on your decisions: <strong>B</strong> round to 12px, <strong>B</strong> Tailwind classes,{" "}
          <strong>A</strong> text-caption badges, <strong>3 tracking values</strong>,{" "}
          ...
          <Card key={cat}>
            <CardHeader className="pb-3">
              <CardTitle className="text-subheader font-normal flex items-center gap-2">
                ...
                {CATEGORY_LABELS[cat]}
                <Badge variant="secondary" className="text-caption font-normal ml-1">
      ...
      <Card>
        ...
        <CardContent>
          <div className="max-w-2xl space-y-6 p-6 bg-muted/20 rounded-lg border">
            ...
            <div className="text-hero tracking-tight">Climate Action Hub</div>
            <div className="text-caption font-semibold uppercase tracking-wider text-muted-foreground">OVERVIEW</div>
            <div className="text-page-title font-semibold tracking-tight">About this Space</div>
            ...
            <div className="flex items-center gap-2">
              <Badge className="text-caption">Innovation</Badge>
              <Badge variant="secondary" className="text-caption">Climate</Badge>
              <Badge variant="outline" className="text-caption">Private</Badge>
            </div>
            <Separator />
            <div className="text-subsection-title">Recent Activity</div>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-body-emphasis">Sarah Chen</span>
                  <span className="text-caption text-muted-foreground ml-2">posted a document</span>
                </div>
                <span className="text-caption text-muted-foreground">3 min ago</span>
              </div>
              <div className="text-subheader font-semibold">Carbon Capture Framework v2</div>
 ...
 <Button size="sm" variant="outline">Learn More</Button>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-body text-muted-foreground">
            ...
            inside a <code className="text-caption bg-muted px-1 py-0.5 rounded font-mono">prose</code> wrapper.
  ...
  return { name: tech.name, score };
            ...
            <div className="space-y-4 text-body">
              <h3 className="text-subheader font-semibold">Token Mapping</h3>
              <p className="text-muted-foreground text-body">
                How each element in the prose maps to a user-input token:
              </p>
              <div className="space-y-2">
                {[
                  { el: "<h1>", token: "Prose H1", tw: "text-page-title", note: "24px — deliberately smaller than system Page Title (30px) so users can't override the page header visually" },
                  { el: "<h2>", token: "Prose H2", tw: "text-section-title tracking-tight", note: "20px — matches production h5 semantic level" },
                  { el: "<h3>", token: "Prose H3", tw: "text-subsection-title", note: "18px — same as Card Title, works well for sub-sections" },
                  { el: "<p>", token: "Body Large", tw: "text-subheader font-normal", note: "16px — the default reading paragraph size" },
                  ...
                  { el: "<code>", token: "Prose Code", tw: "text-body font-mono", note: "14px monospace — slightly smaller than body" },
                  { el: "<pre>", token: "Prose Code", tw: "text-body font-mono", note: "Block code uses same token in a styled container" },
                  { el: "<blockquote>", token: "Prose Small", tw: "text-body", note: "14px — visually de-emphasized with left border" },
                  { el: "<ul>/<ol>", token: "Body Large", tw: "text-subheader font-normal", note: "Lists inherit the paragraph token" },
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-3 py-2 border-b border-border/30">
                    <code className="text-caption bg-muted px-1.5 py-0.5 rounded font-mono shrink-0 w-24">{item.el}</code>
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-caption text-muted-foreground mt-0.5">{item.note}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 p-4 rounded-lg border bg-amber-50/50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800/40">
                <h4 className="text-card-title text-amber-800 dark:text-amber-400 mb-1">Production comparison</h4>
                <p className="text-caption text-amber-700 dark:text-amber-500 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-section-title">Typography Decisions</h1>
            </div>
          </div>
