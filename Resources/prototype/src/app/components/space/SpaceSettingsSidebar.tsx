  ...
  return (
    <aside className={cn("w-64 bg-muted/30 border-r border-border h-full flex flex-col shrink-0", className)}>
      <div className="p-4 border-b border-border bg-background">
        <Link 
          to={`/space/${spaceSlug}`}
          className="flex items-center gap-2 text-body text-muted-foreground hover:text-foreground transition-colors mb-4"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-caption text-muted-foreground">Space Settings</p>
          </div>
        </div>
      </div>
        ...
        {navGroups.map((group) => (
          <div key={group.title}>
            <button
              ...
              className="flex items-center w-full text-caption font-semibold text-muted-foreground mb-2 px-2 hover:text-foreground transition-colors"
            >
