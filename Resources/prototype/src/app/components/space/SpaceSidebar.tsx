      ...
      },
      {
        ...
        constraints: {
          ...
          items: [
            ...
            { id: "harlingen", label: "Harlingen" },
            { id: "leeuwarden", label: "Leeuwarden" },
            { id: "alkmaar", label: "Alkmaar" },
            { id: "zaanstad", label: "Zaanstad" },
            { id: "purmerend", label: "Purmerend" },
            { id: "hoorn", label: "Hoorn" },
            { id: "edam-volendam", label: "Edam-Volendam" },
            { id: "marken", label: "Marken" },
            { id: "volendam", label: "Volendam" },
            { id: "monnickendam", label: "Monnickendam" },
            { id: "weesp", label: "Weesp" },
            { id: "muiden", label: "Muiden" },
            { id: "naarden", label: "Naarden" },
            { id: "bussum", label: "Bussum" },
            { id: "hilversum", label: "Hilversum" },
            { id: "gooi-und-vechtstreek", label: "Gooi en Vechtstreek" },
            { id: "laren", label: "Laren" },
            { id: "blaricum", label: "Blaricum" },
            { id: "wijdemeren", label: "Wijdemeren" },
            { id: "utrechtse-heuvelrug", label: "Utrechtse Heuvelrug" },
            { id: "stichtse-vecht", label: "Stichtse Vecht" },
            { id: "abcoude", label: "Abcoude" },
            { id: "uithoorn", label: "Uithoorn" },
            { id: "amsterdam-zuidoost", label: "Amsterdam-Zuidoost" },
            { id: "baarn", label: "Baarn" },
            { id: "bilthoven", label: "Bilthoven" },
            { id: "zeist", label: "Zeist" },
            { id: "soest", label: "Soest" },
            { id: "leusden", label: "Leusden" },
            { id: "veenendaal", label: "Veenendaal" },
            { id: "renswoude", label: "Renswoude" },
            { id: "wijk-bij-duurstede", label: "Wijk bij Duurstede" },
            { id: "oudewater", label: "Oudewater" },
            { id: "montfoort", label: "Montfoort" },
            { id: "linschoten", label: "Linschoten" },
            { id: "tienhoven", label: "Tienhoven" },
            { id: "haastrecht", label: "Haastrecht" },
            { id: "zevenbergen", label: "Zevenbergen" },
            { id: "nieuw-lekkerland", label: "Nieuw-Lekkerland" },
            { id: "nieuwkoop", label: "Nieuwkoop" },
            { id: "alphen-aan-den-rijn", label: "Alphen aan den Rijn" },
            { id: "katwijk", label: "Katwijk" },
            { id: "lisse", label: "Lisse" },
            { id: "hillegom", label: "Hillegom" },
            { id: "teylingen", label: "Teylingen" },
            { id: "oegstgeest", label: "Oegstgeest" },
            { id: "voorschoten", label: "Voorschoten" },
            { id: "warmond", label: "Warmond" },
            { id: "woubrugge", label: "Woubrugge" },
            { id: "leiderdorp", label: "Leiderdorp" },
            { id: "hazerswoude", label: "Hazerswoude" },
