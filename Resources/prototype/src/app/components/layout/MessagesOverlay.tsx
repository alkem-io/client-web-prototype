...
export function MessagesOverlay() {
 ...
 <IconButton variant="ghost" tooltipLabel="Call" className="text-muted-foreground"><Phone className="h-4" /></IconButton>
 <IconButton variant="ghost" tooltipLabel="Video call" className="text-muted-foreground"><Video className="h-4" /></IconButton>
 <IconButton variant="ghost" tooltipLabel="More options" className="text-muted-foreground"><MoreVertical className="h-4" /></IconButton>
 </div>
 </div>
 ...
 >
 <IconButton variant="ghost" tooltipLabel="Attach file" className="shrink-0 text-muted-foreground"><Paperclip className="h-4" /></IconButton>
 <input
 type="text"
