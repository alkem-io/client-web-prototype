...
export function MessagesPopover() {
 ...
 <IconButton variant="ghost" tooltipLabel="Call" className="text-muted-foreground">
 <Phone className="w-3.5 h-3.5" />
 </IconButton>
 <IconButton variant="ghost" tooltipLabel="Video call" className="text-muted-foreground">
