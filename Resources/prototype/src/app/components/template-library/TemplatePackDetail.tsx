...
export function TemplatePackDetail() {
 ...
 <IconButton variant="ghost" tooltipLabel="Settings" className="shrink-0" onClick={() => navigate(`/templates/packs/${packSlug}/settings`)}>
 <Settings className="w-4 h-4" />
 </IconButton>

 <IconButton variant="ghost" tooltipLabel="Share" className="shrink-0">
