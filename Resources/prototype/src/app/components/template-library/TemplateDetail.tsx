...
function TemplateHeader({ template, onBack, onApply, packSlug, templateId }: { template: any, onBack: () => void, onApply: () => void, packSlug?: string, templateId?: string }) {
 ...
 {templateId && (
 <IconButton variant="ghost" tooltipLabel="Settings" onClick={() => navigate(packSlug ? `/templates/packs/${packSlug}/settings/templates/${templateId}` : `/templates/${templateId}/settings`)}>
