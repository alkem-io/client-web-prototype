...
export function ResponseDetailDialog({ open, onOpenChange, responseId }: ResponseDetailDialogProps) {
 ...
 <DialogContent className="w-[calc(100%-2rem)] sm:max-w-7xl h-[95vh] p-0 gap-0 overflow-hidden flex flex-col bg-background border-none shadow-2xl rounded-xl z-[60]">
 ...
 <IconButton variant="ghost" tooltipLabel="Close" onClick={() => onOpenChange(false)} className="text-muted-foreground hover:text-foreground rounded-full">
 <X className="w-5 h-5" />
 </IconButton>
 </div>
 </div>
