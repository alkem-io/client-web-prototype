    ...
    <Card className="overflow-hidden hover:shadow-md transition-all duration-300 group cursor-pointer border-border/50">
      <CardContent className="p-4 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-body text-muted-foreground truncate">{role}</p>
        </div>
        <div className="flex items-center gap-1 text-caption text-muted-foreground bg-secondary/50 px-2 py-1 rounded-full">
