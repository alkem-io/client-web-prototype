                ...
                <div className="relative aspect-video bg-muted overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3">
                    <Badge variant="default" className={cn(
                      ...
                      space.plan === "Premium" ? "bg-primary/90 hover:bg-primary" : 
                      space.plan === "Plus" ? "bg-chart-2/90 hover:bg-chart-2" : "bg-muted-foreground/90 hover:bg-muted-foreground"
                    )}>
                      {space.plan}
                    </Badge>
                  </div>
                ...
                <Card key={pack.id} className="flex items-center p-4 gap-4 hover:border-primary/50 transition-colors group">
                  ...
                  <div className="flex-1 min-w-0">
                   ...
                   <div className="text-xs text-muted-foreground font-medium px-2 py-1 bg-muted rounded">
                    {pack.capacity.used}/{pack.capacity.total}
                  </div>
