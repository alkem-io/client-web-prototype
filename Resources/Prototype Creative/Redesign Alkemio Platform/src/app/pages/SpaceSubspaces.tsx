    ...
    <div className="container mx-auto px-4 md:px-6 py-8">
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex-1 w-full min-w-0">
          <div className={`sticky ${showDrawer ? "top-0" : "top-16"} z-30 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-2 mb-6 -mx-4 px-4 md:mx-0 md:px-0 border-b border-border/50`}>
