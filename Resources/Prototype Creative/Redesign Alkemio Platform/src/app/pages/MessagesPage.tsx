...
const MESSAGES: Record<string, ChatMessage[]> = {
  "1": [
    { id: "m1", sender: "them", text: "Hey Alex! Have you looked at the latest sustainability report?", time: "10:30 AM", read: true },
    { id: "m2", sender: "me", text: "Not yet, I was planning to review it this afternoon. Anything specific I should focus on?", time: "10:32 AM", read: true },
    { id: "m3", sender: "them", text: "The section on renewable energy targets — there are some interesting projections we should discuss with the team.", time: "10:34 AM", read: true },
    { id: "m4", sender: "me", text: "Great, I'll pay special attention to that section. Want to set up a quick call after I've reviewed it?", time: "10:36 AM", read: true },
    { id: "m5", sender: "them", text: "That sounds great! Let me check the data and get back to you with some specific points.", time: "10:38 AM", read: false },
    { id: "m6", sender: "them", text: "Also, there's a new dataset from the municipality we should incorporate.", time: "10:38 AM", read: false },
  ],
  "2": [
    { id: "m7", sender: "them", text: "The prototype is ready for review. I've deployed it to the staging environment.", time: "9:15 AM", read: true },
    { id: "m8", sender: "me", text: "Awesome, I'll take a look right away!", time: "9:20 AM", read: true },
  ],
};
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <span
                    ...
                    style={{
                      fontSize: "var(--text-sm)",
                      fontWeight: c.unread > 0 ? 600 : "var(--font-weight-normal)" as any,
                      color: "var(--foreground)",
                    }}
                  >
                    {c.name}
