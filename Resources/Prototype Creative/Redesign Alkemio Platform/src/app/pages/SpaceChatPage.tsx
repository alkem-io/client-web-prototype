...
import { SpaceChannelView } from "@/app/components/messaging/SpaceChannelView";
...
export function SpaceChatPage() {
  ...
  // Only accessible for Variant C or E — redirect otherwise
  if (variant !== "C" && variant !== "E") {
    return <Navigate to={`/space/${slug}`} replace />;
  }
        ...
        <div className="container mx-auto px-4 md:px-6 pt-6 pb-4 flex-1 flex flex-col min-h-0">
          <div className="flex flex-col lg:flex-row gap-6 flex-1 min-h-0">
            ...
            <div className="flex-1 w-full min-w-0 flex flex-col min-h-0">
              ...
              >
                {variant === "E" ? (
                  <SpaceChannelView spaceSlug={slug} />
                ) : (
