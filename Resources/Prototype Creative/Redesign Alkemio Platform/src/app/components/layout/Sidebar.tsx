...
export function Sidebar({ className }: { className?: string }) {
  ...
  const navItems = [
    ...
    { icon: FolderOpen, label: t("nav.browseSpaces"), href: "/spaces" },
    { icon: Library, label: t("nav.templateLibrary"), href: "/templates" },
    { icon: Plus, label: t("nav.createSpace"), href: "/create-space" },
    { icon: Mail, label: t("nav.invitations"), onClick: () => setShowInvitations(true), badge: 2 },
  ];

  const spaces = [
    { name: "Innovation Hub", initials: "IH", color: "bg-primary/10 text-primary", href: "/space/innovation-hub" },
    { name: "Community Garden", initials: "CG", color: "bg-chart-2/10 text-chart-2", href: "/space/community-garden" },
    { name: "Digital Transformation", initials: "DT", color: "bg-chart-3/10 text-chart-3", href: "/space/digital-trans" },
  ];
