...
const SPACE_DEFS: Record<string, SpaceDef[]> = {
  '1': [
    { id: 'innovation-hub', name: 'Innovation Hub', level: 'L0', image: IMG.innovationHub, location: { lat: 52.37, lng: 4.90 } },
    { id: 'smart-cities', name: 'Smart Cities Lab', level: 'L1', parent: 'innovation-hub', image: IMG.smartCities, location: { lat: 52.08, lng: 4.31 } },
    { id: 'circular-econ', name: 'Circular Economy', level: 'L1', parent: 'innovation-hub', image: IMG.circularEcon, location: { lat: 52.34, lng: 5.02 } },
    { id: 'digital-health', name: 'Digital Health', level: 'L1', parent: 'innovation-hub', image: IMG.digitalHealth, location: { lat: 52.43, lng: 4.82 } },
  ],
  '2': [
...
const ORG_DEFS: OrgDef[] = [
  ...
  { id: 'philips-health', name: 'Philips Health', leads: ['digital-health'], memberOf: ['smart-cities', 'innovation-hub'] },
  ...
  { id: 'gemeente-adam', name: 'Municipality Amsterdam', leads: ['bike-infra'], memberOf: ['smart-cities', 'circular-econ', 'innovation-hub'] },
  { id: 'rabobank', name: 'Rabobank', leads: [], memberOf: ['circular-econ', 'innovation-hub', 'green-energy'] },
];
...
const PERSON_DEFS: PersonDef[] = [
  ...
  { id: 'sophie-mulder', name: 'Sophie Mulder', orgId: 'gemeente-adam', spaces: ['bike-infra', 'smart-cities', 'innovation-hub', 'circular-econ'], image: IMG.sophieMulder },
  ...
  { id: 'marco-groot', name: 'Marco de Groot', orgId: 'rabobank', spaces: ['innovation-hub', 'circular-econ', 'urban-mobility', 'green-energy'], image: IMG.marcoGroot },
  { id: 'marie-janssen', name: 'Dr. Marie Janssen', orgId: 'philips-health', spaces: ['digital-health', 'smart-cities', 'innovation-hub'], image: IMG.sophieMulder },
];
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div 
          ...
          style={{ 
            ...
            boxShadow: selectedNode ? '-4px 0 24px rgba(0,0,0,0.08)' : 'none',
