  ...
  if (type === "Whiteboard") {
     return (
       <div className="w-full h-full bg-muted/30 relative overflow-hidden p-2 group-hover:bg-muted/50 transition-colors">
          <div className="absolute top-4 left-6 w-14 h-14 bg-yellow-100 shadow-sm rounded-sm transform -rotate-2 border border-yellow-200 flex items-center justify-center">
            <div className="w-8 h-1 bg-yellow-200/50 rounded-full" />
          </div>
          <div className="absolute top-12 left-28 w-16 h-12 bg-blue-100 shadow-sm rounded-sm transform rotate-3 border border-blue-200" />
          <div className="absolute top-24 left-10 w-12 h-12 bg-pink-100 shadow-sm rounded-full transform rotate-1 border border-pink-200" />
  ...
  if (type === "Subspace") {
     return (
        <div className="w-full h-full relative bg-muted overflow-hidden">
             ...
             <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/60 to-transparent pt-8">
                <div className="flex items-center gap-2">
                    <div className="w-5 h-5 rounded bg-indigo-500/20 backdrop-blur flex items-center justify-center border border-indigo-200/30">
  ...
  return (
    ...
    >
        ...
        <div className="absolute top-3 right-3">
             <Badge 
               ...
               className={cn(
                 ...
                 (template.type === "Space" || template.type === "Whiteboard" || template.type === "Subspace") ? "bg-white/90 text-foreground" : "bg-slate-100/90 text-slate-700"
               )}
             >
               {template.type}
             </Badge>
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {template.packId && (
          <div className="mt-4">
              <Badge variant="secondary" className="h-5 px-1.5 text-[10px] font-normal bg-blue-50 text-blue-700 border-blue-100 flex items-center gap-1 w-fit max-w-full truncate">
