  ...
  return (
    <div className="relative rounded-xl overflow-hidden min-h-[300px] flex items-center p-8 md:p-12 shadow-md">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0" style={{ background: 'color-mix(in srgb, var(--foreground) 50%, transparent)', mixBlendMode: 'multiply' }} />
      </div>

      {/* Content */}
      <div className="relative z-10 max-w-3xl space-y-6">
        <div className="space-y-2">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight" style={{ color: 'var(--primary-foreground)' }}>
            Welcome, Jeroen!
          </h1>
          <p className="text-xl md:text-2xl font-light" style={{ color: 'color-mix(in srgb, var(--primary-foreground) 90%, transparent)' }}>
