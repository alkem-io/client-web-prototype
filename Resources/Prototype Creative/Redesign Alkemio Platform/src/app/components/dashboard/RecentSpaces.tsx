            ...
            <div key={space.id} className="px-2">
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  {space.isPrivate && (
                    <div className="absolute top-3 right-3 backdrop-blur-sm p-1.5 rounded-full" style={{ background: 'color-mix(in srgb, var(--foreground) 50%, transparent)', color: 'var(--primary-foreground)' }}>
