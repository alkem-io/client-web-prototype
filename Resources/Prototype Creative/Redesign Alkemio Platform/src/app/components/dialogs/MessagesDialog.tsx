...
const messages = [
  ...
  { id: 3, sender: "them", text: "I was thinking we should adjust the target for the Innovation Hub space. It seems a bit ambitious given the current timeline.", time: "10:33 AM" },
