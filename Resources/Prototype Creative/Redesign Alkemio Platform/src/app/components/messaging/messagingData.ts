...
export const MESSAGES: Record<string, Message[]> = {
  "dm-sarah": [
    ...
    },
    {
      ...
      senderAvatar: USERS.sarah.avatar,
      senderInitials: "SC",
      content: "I was thinking we should adjust the target for the Innovation Hub space. The current timeline seems a bit ambitious given the resource constraints we discussed last week.",
  ...
  "space-innovation": [
    {
      ...
      senderInitials: "TV",
      content: "Welcome everyone to the Innovation Hub channel! This is our shared space for quick coordination and updates.",
